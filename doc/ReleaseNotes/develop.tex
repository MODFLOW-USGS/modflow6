...
% after a release has just been made.
	...
	\begin{itemize}
		...
		\item For a UZF setup with multiple UZF objects in a cell, the auxmultname option was tripping an error message when it should have worked.  An if statement was altered in the UZF source code and a new autotest implemented to ensure that the multiple UZF objects per cell works when it should and fails when the cumulative area of the UZF objects within a cell exceed the cell's total area.
	%	\item xxx
	\end{itemize}

...
\begin{itemize}
	...
	\begin{itemize}
	        \item Allow the XT3D option to be applied to GWF-GWF Exchanges.  XT3D is a powerful alternative to the ghost-node correction approach.  XT3D can now be optionally activated for a GWF-GWT Exchange by specifying the XT3D keyword in the OPTIONS block.
	        \item GWT-GWT XXX provided description here...

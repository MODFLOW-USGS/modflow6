...
\begin{itemize}
	\item Version mf6.2.1--February 17, 2021
	...
	\underline{EXAMPLES}
	\begin{itemize}
	        \item Added example ex-gwt-mt3dms-p02.
	        \item Added example ex-gwt-rotate.
	        \item Added example ex-gwt-saltlake.
	        \item Added example ex-gwt-uzt-2d.
	\end{itemize}

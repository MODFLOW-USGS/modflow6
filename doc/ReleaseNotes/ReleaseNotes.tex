...
%	\end{itemize}
	...
	\begin{itemize}
	        ...
	        \item The new binary output file for mean water contents was reporting a value of 0.0 for cells below the water table.  In this situation, the water content is now set to the saturated water content.  With this approach, the mean water content reported in the binary output file matches the UZF water-content point observation (by depth) approach.
	\end{itemize}

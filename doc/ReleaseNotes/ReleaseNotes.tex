...
%	\end{itemize}
	...
	\begin{itemize}
	        ...
	        \item The new binary output file for mean water contents was reporting a value of 0.0 for cells below the water table. When this situation occurs, the water content is instead set to the saturated water content.  Using this approach, the mean water content reported in the binary output file matches the water content reported by the observation-by-depth option.
	\end{itemize}

...
\begin{itemize}
	...
	\underline{EXAMPLES}
	\begin{itemize}
		\item Four new example problems added to the ``autotest'' folder that tests the functionality of the new Viscosity (VSC) Package and named test\_gwf\_vsc01, test\_gwf\_vsc02, test\_gwf\_vsc03\_sfr, and test\_gwf\_vsc04\_lak
	%	\item xxx
	%	\item xxx
	\end{itemize}

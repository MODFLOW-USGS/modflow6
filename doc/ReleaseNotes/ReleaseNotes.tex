...
%	\end{itemize}
	...
	\begin{itemize}
	        \item -- The UZF water-content observation type was inappropriately erroring-out because an error check was using the wrong index to retrieve the cell top and bottom elevations associated with uzf object.  With the proper index now applied, the output works as expected.
	        \item --
	\end{itemize}

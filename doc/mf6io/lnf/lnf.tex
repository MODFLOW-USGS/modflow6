This section describes the data files for a \mf Linear Network FLow (LNF) Model.  A LNF Model is added to the simulation by including a LNF entry in the MODELS block of the simulation name file.

...
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-zdg-options.dat}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-zdg-dimensions.dat}
\vspace{5mm}
\noindent \textit{FOR ANY STRESS PERIOD}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-zdg-period.dat}
\packageperioddescription

\vspace{5mm}
\subsubsection{Explanation of Variables}
\begin{description}
\input{./mf6ivar/tex/olf-zdg-desc.tex}
\end{description}

\vspace{5mm}
\subsubsection{Example Input File}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/olf-zdg-example.dat}

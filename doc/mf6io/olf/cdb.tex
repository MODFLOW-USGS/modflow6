...
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-cdb-options.dat}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-cdb-dimensions.dat}
\vspace{5mm}
\noindent \textit{FOR ANY STRESS PERIOD}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/olf-cdb-period.dat}
\packageperioddescription

\vspace{5mm}
\subsubsection{Explanation of Variables}
\begin{description}
\input{./mf6ivar/tex/olf-cdb-desc.tex}
\end{description}

\vspace{5mm}
\subsubsection{Example Input File}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/olf-cdb-example.dat}

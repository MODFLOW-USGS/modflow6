...
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/utl-ssmi-options.dat}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/utl-ssmi-dimensions.dat}
\vspace{5mm}
\noindent \textit{FOR ANY STRESS PERIOD}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/utl-ssmi-period.dat}

\vspace{5mm}
\subsubsection{Explanation of Variables}
\begin{description}
\input{./mf6ivar/tex/utl-ssmi-desc.tex}
\end{description}

\subsubsection{Example Input File}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/utl-ssmi-example.dat}

...
\item \texttt{sgm}---is specific gravity of moist or unsaturated sediments.  If not specified, then a default value of 1.7 is assigned.

\item \texttt{sgs}---is specific gravity of saturated sediments. If not specified, then a default value of 2.0 is assigned.

...
\item \texttt{DELAY\_FULL\_CELL}---keyword to indicate that head-based delay interbeds will be simulated using a full-cell approach. This option is only used if HEAD\_BASED is specified in the OPTIONS block.

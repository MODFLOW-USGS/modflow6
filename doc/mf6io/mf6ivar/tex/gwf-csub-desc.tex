...
\item \texttt{UPDATE\_MATERIAL\_PROPERTIES}---keyword to indicate that the thickness and void ratio of coarse-grained and no delay interbed sediments will vary during the simulation. If not specified, the thickness and void ratio of coarse-grained and no delay interbed sediments will not vary during the simulation.

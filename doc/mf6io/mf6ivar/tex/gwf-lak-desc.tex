...
\item \texttt{STRT}---keyword to specify that starting head for the lakes is read from a binary file.

\item \texttt{FILEIN}---keyword to specify that an input filename is expected next.

\item \texttt{strt\_filename}---name of input file to define starting head for the LAK package

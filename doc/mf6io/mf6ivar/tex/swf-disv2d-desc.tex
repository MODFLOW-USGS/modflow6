...
\begin{description}
\item \texttt{nodes}---is the number of cells per layer.  This is a constant value for the grid and it applies to all layers.
...
\begin{description}
\item \texttt{bottom}---is the bottom elevation for each cell.

...
\item \texttt{storage\_weight}---real number value that defines the time weighting factor used to calculate the change in channel storage. STORAGE_WEIGHT has a value between 0.5 and 1. Default STORAGE_WEIGHT value is 0.5.

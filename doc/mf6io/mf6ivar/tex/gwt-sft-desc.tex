...
\item \texttt{flowbudgetfile}---name of the binary lake sfr budget file to read as input for the SFT Package.  This budget file can be created by running a separate GWF Model with the SFR Package and saving the flows to the budget file.

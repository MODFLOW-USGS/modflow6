...
\item \texttt{EXTEND}---indicates that particles should be tracked beyond the end of the simulation's final time step, until particles terminate or reach a specified stop time.  By default, particles are terminated at the end of the simulation's final time step.

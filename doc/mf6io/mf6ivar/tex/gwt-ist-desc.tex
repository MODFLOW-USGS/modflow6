...
\item \texttt{fim}---is the immobile domain solid mass fraction, in dimensions of mass per mass.  FIM represents the mass of immobile solid aquifer material that is available for immobile domain sorptive exchange per mass of total solid aquifer material.  If not specifed, then this mass fraction is approximated to be the immobile domain porosity (THETAIM) divided by the total porosity (the sum of all immobile domain porosities and the mobile domain porosity).

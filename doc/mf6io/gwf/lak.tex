...
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/utl-tab-dimensions.dat}
\lstinputlisting[style=blockdefinition]{./mf6ivar/tex/utl-tab-table.dat}
\vspace{5mm}

\vspace{5mm}
\subsubsection{Explanation of Variables}
\begin{description}
\input{./mf6ivar/tex/utl-tab-desc.tex}
\end{description}

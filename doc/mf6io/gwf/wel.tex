...
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-wel-example-dis.dat}

\noindent \textbf{Discretization by Vertices Example}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-wel-example-disv.dat}

\noindent \textbf{Unstructured Discretization Example}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-wel-example-disu.dat}

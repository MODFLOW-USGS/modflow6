...
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-chd-example-dis.dat}

\noindent \textbf{Discretization by Vertices Example}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-chd-example-disv.dat}

\noindent \textbf{Unstructured Discretization Example}
\lstinputlisting[style=inputfile]{./mf6ivar/examples/gwf-chd-example-disu.dat}

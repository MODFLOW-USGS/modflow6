Input to the Time-Varying Hydraulic Conductivity (TVK) Package is read from the file that is specified in the TVK record of the OPTIONS block in the NPF package.

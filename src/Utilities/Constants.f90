module ConstantsModule
  ...
  integer(I4B), parameter :: LENMEMPATH = 2*LENCOMPONENTNAME + LENMEMSEPARATOR
  integer(I4B), parameter :: LENORIGIN = LENMEMPATH                             !<TODO_MJR: this should no longer be used 
  ...
  ENUM, BIND(C)
    ! Sets MEMHIDDEN=0, MEMREADONLY=1, MEMREADWRITE=2 
    ENUMERATOR :: MEMHIDDEN, MEMREADONLY, MEMREADWRITE
  END ENUM

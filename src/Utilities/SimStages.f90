module SimStagesModule
  ...
  integer(I4B), public, parameter :: STG_BEFORE_DF = 3
  integer(I4B), public, parameter :: STG_AFTER_DF = 4
  integer(I4B), public, parameter :: STG_BEFORE_AC = 5
  integer(I4B), public, parameter :: STG_BEFORE_AR = 6
  integer(I4B), public, parameter :: STG_AFTER_AR = 7
  integer(I4B), public, parameter :: STG_BEFORE_AD = 8
  integer(I4B), public, parameter :: STG_BEFORE_CF = 9
  integer(I4B), public, parameter :: STG_BEFORE_FC = 10

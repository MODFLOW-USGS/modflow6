...
!! associated with a single model netcdf input file.  It
!! contains an ordered package load list with block and input
...
contains
  ...
  !!
  !! This routine resets the blocklist.  EVT and RCH list and grid based
  !! inputs share the same file type (e.g. RCH6).  This routine is called
  !! when the definition set should be array but was initialized as list.
  !<

...
contains
  ...
  subroutine options_create()
    ...
    integer(I4B), pointer :: simcontinue
    integer(I4B), pointer :: nocheck
    integer(I4B), pointer :: maxerror
  ...
  subroutine models_create()
    ...
    call create_models(mtypes, mnames, mfnames)
  ...
  subroutine exchanges_create()
    ...
    call create_exchanges(etypes, efiles, emempaths, emnames_a, emnames_b)
  ...
  subroutine solution_groups_create()
    ...
    character(len=LINELENGTH) :: stype
  ...
  subroutine create_load_balance(mranks)
    ...
    integer(I4B) :: nr_gwf_models
    integer(I4B) :: nr_gwt_models
    integer(I4B) :: nr_exchanges
    integer(I4B) :: min_per_proc
    integer(I4B) :: nr_left
    integer(I4B) :: rank

...
contains
  ...
  subroutine create(this, model, m_id, m_name, macronym)
    ...
    call this%load(this%dis_nodes, 'NODES', 'DIS', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
    call this%load(this%dis_nja, 'NJA', 'DIS', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
    call this%load(this%dis_njas, 'NJAS', 'DIS', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)

    if (this%macronym == 'GWF') then
      call this%load(this%npf_iangle1, 'IANGLE1', 'NPF', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%npf_iangle2, 'IANGLE2', 'NPF', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%npf_iangle3, 'IANGLE3', 'NPF', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%npf_iwetdry, 'IWETDRY', 'NPF', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
    end if

    if (this%macronym == 'GWT') then
      call this%load(this%dsp_idiffc, 'IDIFFC', 'DSP', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%dsp_idisp, 'IDISP', 'DSP', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%indsp, 'INDSP', '', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
      call this%load(this%inmst, 'INMST', '', (/STG_AFTER_MDL_DF/), MAP_TYPE_NA)
    end if

module GwfNpfModule
  ...
  use InitialConditionsModule, only: IcType
  ...
  use MathUtilModule, only: logmean
  ...
  type, extends(NumericalPackageType) :: GwfNpfType
    ...
    type(IcType), pointer :: ic => null() !< initial conditions object
...
contains
  ...
  subroutine npf_ar(this, ic, vsc, ibound, hnew)
    ...
    ! -- dummy
    class(GwfNpftype) :: this !< instance of the NPF package
    type(IcType), pointer, intent(in) :: ic !< initial conditions

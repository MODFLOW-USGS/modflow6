...
! ******************************************************************************
! wel_options -- set options specific to WellType
!
...
! ------------------------------------------------------------------------------
    ...
    ! -- dummy
    class(WellType),   intent(inout) :: this

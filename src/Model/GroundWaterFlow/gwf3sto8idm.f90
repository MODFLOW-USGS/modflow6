...
module GwfStoInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwfsto_stosetting = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'STO', & ! subcomponent
    'PERIOD', & ! block
    'STOSETTING', & ! tag name
    'STOSETTING', & ! fortran variable
    'KEYSTRING STEADY-STATE TRANSIENT', & ! type
    '', & ! shape
    .true., & ! required
    .true., & ! multi-record
    .false., & ! preserve case
  ...
  type(InputParamDefinitionType), parameter :: &
    gwfsto_perioddata = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'STO', & ! subcomponent
    'PERIOD', & ! block

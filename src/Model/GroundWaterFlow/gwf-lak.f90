...
999 return
  ...
  subroutine lak_da(this)
    ...
    call mem_deallocate(this%dbuff, 'DBUFF', this%memoryPath)
    deallocate (this%cauxcbc)
    call mem_deallocate(this%qauxcbc, 'QAUXCBC', this%memoryPath)
    call mem_deallocate(this%qleak, 'QLEAK', this%memoryPath)
    call mem_deallocate(this%qsto, 'QSTO', this%memoryPath)
    call mem_deallocate(this%denseterms, 'DENSETERMS', this%memoryPath)
    call mem_deallocate(this%viscratios, 'VISCRATIOS', this%memoryPath)
    !
    ! -- tables
    if (this%ntables > 0) then
      call mem_deallocate(this%ialaktab, 'IALAKTAB', this%memoryPath)
      call mem_deallocate(this%tabstage, 'TABSTAGE', this%memoryPath)
      call mem_deallocate(this%tabvolume, 'TABVOLUME', this%memoryPath)
      call mem_deallocate(this%tabsarea, 'TABSAREA', this%memoryPath)
      call mem_deallocate(this%tabwarea, 'TABWAREA', this%memoryPath)
    end if
    !
    ! -- budobj
    ...
    ! -- outlets
    if (this%noutlets > 0) then
      call mem_deallocate(this%lakein, 'LAKEIN', this%memoryPath)
      call mem_deallocate(this%lakeout, 'LAKEOUT', this%memoryPath)
      call mem_deallocate(this%iouttype, 'IOUTTYPE', this%memoryPath)
      call mem_deallocate(this%outrate, 'OUTRATE', this%memoryPath)
      call mem_deallocate(this%outinvert, 'OUTINVERT', this%memoryPath)
      call mem_deallocate(this%outwidth, 'OUTWIDTH', this%memoryPath)
      call mem_deallocate(this%outrough, 'OUTROUGH', this%memoryPath)
      call mem_deallocate(this%outslope, 'OUTSLOPE', this%memoryPath)
      call mem_deallocate(this%simoutrate, 'SIMOUTRATE', this%memoryPath)
    end if
    !
    ! -- stage table
    ...
    !
    ! -- scalars
    call mem_deallocate(this%iprhed, 'IPRHED', this%memoryPath)
    call mem_deallocate(this%istageout, 'ISTAGEOUT', this%memoryPath)
    ...
    call mem_deallocate(this%nlakes, 'NLAKES', this%memoryPath)
    call mem_deallocate(this%noutlets, 'NOUTLETS', this%memoryPath)
    call mem_deallocate(this%ntables, 'NTABLES', this%memoryPath)
    call mem_deallocate(this%convlength, 'CONVLENGTH', this%memoryPath)
    call mem_deallocate(this%convtime, 'CONVTIME', this%memoryPath)
    call mem_deallocate(this%outdmax, 'OUTDMAX', this%memoryPath)
    call mem_deallocate(this%igwhcopt, 'IGWHCOPT', this%memoryPath)
    call mem_deallocate(this%iconvchk, 'ICONVCHK', this%memoryPath)
    call mem_deallocate(this%iconvresidchk, 'ICONVRESIDCHK', this%memoryPath)
    call mem_deallocate(this%maxlakit, 'MAXLAKIT', this%memoryPath)
    call mem_deallocate(this%surfdep, 'SURFDEP', this%memoryPath)
    call mem_deallocate(this%dmaxchg, 'DMAXCHG', this%memoryPath)
    call mem_deallocate(this%delh, 'DELH', this%memoryPath)
    call mem_deallocate(this%pdmax, 'PDMAX', this%memoryPath)
    call mem_deallocate(this%check_attr, 'CHECK_ATTR', this%memoryPath)
    call mem_deallocate(this%bditems, 'BDITEMS', this%memoryPath)
    call mem_deallocate(this%cbcauxitems, 'CBCAUXITEMS', this%memoryPath)
    call mem_deallocate(this%idense, 'IDENSE', this%memoryPath)
    !
    call mem_deallocate(this%nlakeconn, 'NLAKECONN', this%memoryPath)
    call mem_deallocate(this%idxlakeconn, 'IDXLAKECONN', this%memoryPath)
    call mem_deallocate(this%ntabrow, 'NTABROW', this%memoryPath)
    call mem_deallocate(this%strt, 'STRT', this%memoryPath)
    call mem_deallocate(this%laketop, 'LAKETOP', this%memoryPath)
    call mem_deallocate(this%lakebot, 'LAKEBOT', this%memoryPath)
    call mem_deallocate(this%sareamax, 'SAREAMAX', this%memoryPath)
    call mem_deallocate(this%stage, 'STAGE', this%memoryPath)
    call mem_deallocate(this%rainfall, 'RAINFALL', this%memoryPath)
    call mem_deallocate(this%evaporation, 'EVAPORATION', this%memoryPath)
    call mem_deallocate(this%runoff, 'RUNOFF', this%memoryPath)
    call mem_deallocate(this%inflow, 'INFLOW', this%memoryPath)
    call mem_deallocate(this%withdrawal, 'WITHDRAWAL', this%memoryPath)
    call mem_deallocate(this%lauxvar, 'LAUXVAR', this%memoryPath)
    call mem_deallocate(this%avail, 'AVAIL', this%memoryPath)
    call mem_deallocate(this%lkgwsink, 'LKGWSINK', this%memoryPath)
    call mem_deallocate(this%ncncvr, 'NCNCVR', this%memoryPath)
    call mem_deallocate(this%surfin, 'SURFIN', this%memoryPath)
    call mem_deallocate(this%surfout, 'SURFOUT', this%memoryPath)
    call mem_deallocate(this%surfout1, 'SURFOUT1', this%memoryPath)
    call mem_deallocate(this%precip, 'PRECIP', this%memoryPath)
    call mem_deallocate(this%precip1, 'PRECIP1', this%memoryPath)
    call mem_deallocate(this%evap, 'EVAP', this%memoryPath)
    call mem_deallocate(this%evap1, 'EVAP1', this%memoryPath)
    call mem_deallocate(this%evapo, 'EVAPO', this%memoryPath)
    call mem_deallocate(this%withr, 'WITHR', this%memoryPath)
    call mem_deallocate(this%withr1, 'WITHR1', this%memoryPath)
    call mem_deallocate(this%flwin, 'FLWIN', this%memoryPath)
    call mem_deallocate(this%flwiter, 'FLWITER', this%memoryPath)
    call mem_deallocate(this%flwiter1, 'FLWITER1', this%memoryPath)
    call mem_deallocate(this%seep, 'SEEP', this%memoryPath)
    call mem_deallocate(this%seep1, 'SEEP1', this%memoryPath)
    call mem_deallocate(this%seep0, 'SEEP0', this%memoryPath)
    call mem_deallocate(this%stageiter, 'STAGEITER', this%memoryPath)
    call mem_deallocate(this%chterm, 'CHTERM', this%memoryPath)
    !
    ! -- lake boundary and stages
    call mem_deallocate(this%iboundpak, 'IBOUND', this%memoryPath)
    call mem_deallocate(this%xnewpak, 'XNEWPAK', this%memoryPath)
    call mem_deallocate(this%xoldpak, 'XOLDPAK', this%memoryPath)
    !
    ! -- lake iteration variables
    call mem_deallocate(this%iseepc, 'ISEEPC', this%memoryPath)
    call mem_deallocate(this%idhc, 'IDHC', this%memoryPath)
    call mem_deallocate(this%en1, 'EN1', this%memoryPath)
    call mem_deallocate(this%en2, 'EN2', this%memoryPath)
    call mem_deallocate(this%r1, 'R1', this%memoryPath)
    call mem_deallocate(this%r2, 'R2', this%memoryPath)
    call mem_deallocate(this%dh0, 'DH0', this%memoryPath)
    call mem_deallocate(this%s0, 'S0', this%memoryPath)
    call mem_deallocate(this%qgwf0, 'QGWF0', this%memoryPath)
    !
    ! -- lake connection variables
    call mem_deallocate(this%imap, 'IMAP', this%memoryPath)
    call mem_deallocate(this%cellid, 'CELLID', this%memoryPath)
    call mem_deallocate(this%nodesontop, 'NODESONTOP', this%memoryPath)
    call mem_deallocate(this%ictype, 'ICTYPE', this%memoryPath)
    call mem_deallocate(this%bedleak, 'BEDLEAK', this%memoryPath)
    call mem_deallocate(this%belev, 'BELEV', this%memoryPath)
    call mem_deallocate(this%telev, 'TELEV', this%memoryPath)
    call mem_deallocate(this%connlength, 'CONNLENGTH', this%memoryPath)
    call mem_deallocate(this%connwidth, 'CONNWIDTH', this%memoryPath)
    call mem_deallocate(this%sarea, 'SAREA', this%memoryPath)
    call mem_deallocate(this%warea, 'WAREA', this%memoryPath)
    call mem_deallocate(this%satcond, 'SATCOND', this%memoryPath)
    call mem_deallocate(this%simcond, 'SIMCOND', this%memoryPath)
    call mem_deallocate(this%simlakgw, 'SIMLAKGW', this%memoryPath)
    !

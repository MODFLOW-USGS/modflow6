...
contains
  ...
  subroutine sfr_da(this)
    ...
    !
    ! -- deallocate arrays
    call mem_deallocate(this%qoutflow, 'QOUTFLOW', this%memoryPath)
    call mem_deallocate(this%qextoutflow, 'QEXTOUTFLOW', this%memoryPath)
    ...
    call mem_deallocate(this%iboundpak, 'IBOUNDPAK', this%memoryPath)
    call mem_deallocate(this%igwfnode, 'IGWFNODE', this%memoryPath)
    call mem_deallocate(this%igwftopnode, 'IGWFTOPNODE', this%memoryPath)
    call mem_deallocate(this%length, 'LENGTH', this%memoryPath)
    call mem_deallocate(this%width, 'WIDTH', this%memoryPath)
    call mem_deallocate(this%strtop, 'STRTOP', this%memoryPath)
    call mem_deallocate(this%bthick, 'BTHICK', this%memoryPath)
    call mem_deallocate(this%hk, 'HK', this%memoryPath)
    call mem_deallocate(this%slope, 'SLOPE', this%memoryPath)
    call mem_deallocate(this%nconnreach, 'NCONNREACH', this%memoryPath)
    call mem_deallocate(this%ustrf, 'USTRF', this%memoryPath)
    call mem_deallocate(this%ftotnd, 'FTOTND', this%memoryPath)
    call mem_deallocate(this%usflow, 'USFLOW', this%memoryPath)
    call mem_deallocate(this%dsflow, 'DSFLOW', this%memoryPath)
    call mem_deallocate(this%depth, 'DEPTH', this%memoryPath)
    call mem_deallocate(this%stage, 'STAGE', this%memoryPath)
    call mem_deallocate(this%gwflow, 'GWFLOW', this%memoryPath)
    call mem_deallocate(this%simevap, 'SIMEVAP', this%memoryPath)
    call mem_deallocate(this%simrunoff, 'SIMRUNOFF', this%memoryPath)
    call mem_deallocate(this%stage0, 'STAGE0', this%memoryPath)
    call mem_deallocate(this%usflow0, 'USFLOW0', this%memoryPath)
    ...
    if (this%istorage == 1) then
      call mem_deallocate(this%stageold, 'STAGEOLD', this%memoryPath)
      call mem_deallocate(this%dsflowold, 'DSFLOWOLD', this%memoryPath)
      call mem_deallocate(this%storage, 'STORAGE', this%memoryPath)
      call mem_deallocate(this%usinflow, 'USINFLOW', this%memoryPath)
      call mem_deallocate(this%usinflowold, 'USINFLOWOLD', this%memoryPath)
    end if
    !
    ! -- deallocate reach order and connection data
    call mem_deallocate(this%isfrorder, 'ISFRORDER', this%memoryPath)
    call mem_deallocate(this%ia, 'IA', this%memoryPath)
    call mem_deallocate(this%ja, 'JA', this%memoryPath)
    call mem_deallocate(this%idir, 'IDIR', this%memoryPath)
    call mem_deallocate(this%idiv, 'IDIV', this%memoryPath)
    call mem_deallocate(this%qconn, 'QCONN', this%memoryPath)
    !
    ! -- deallocate boundary data
    call mem_deallocate(this%rough, 'ROUGH', this%memoryPath)
    call mem_deallocate(this%rain, 'RAIN', this%memoryPath)
    ...
    call mem_deallocate(this%sstage, 'SSTAGE', this%memoryPath)
    !
    ! -- deallocate aux variables
    call mem_deallocate(this%rauxvar, 'RAUXVAR', this%memoryPath)
    !
    ! -- deallocate diversion variables
    call mem_deallocate(this%iadiv, 'IADIV', this%memoryPath)
    call mem_deallocate(this%divreach, 'DIVREACH', this%memoryPath)
    if (associated(this%divcprior)) then
      deallocate (this%divcprior)
    end if
    call mem_deallocate(this%divflow, 'DIVFLOW', this%memoryPath)
    call mem_deallocate(this%divq, 'DIVQ', this%memoryPath)
    call mem_deallocate(this%ndiv, 'NDIV', this%memoryPath)
    !
    ! -- deallocate cross-section data
    call mem_deallocate(this%ncrosspts, 'NCROSSPTS', this%memoryPath)
    call mem_deallocate(this%iacross, 'IACROSS', this%memoryPath)
    call mem_deallocate(this%station, 'STATION', this%memoryPath)
    call mem_deallocate(this%xsheight, 'XSHEIGHT', this%memoryPath)
    call mem_deallocate(this%xsrough, 'XSROUGH', this%memoryPath)
    !
    ! -- deallocate budobj
    ...
    !
    ! -- deallocate scalars
    call mem_deallocate(this%istorage, 'ISTORAGE', this%memoryPath)
    call mem_deallocate(this%storage_weight, 'STORAGE_WEIGHT', this%memoryPath)
    ...
    call mem_deallocate(this%idiversions, 'IDIVERSIONS', this%memoryPath)
    call mem_deallocate(this%maxsfrpicard, 'MAXSFRPICARD', this%memoryPath)
    call mem_deallocate(this%maxsfrit, 'MAXSFRIT', this%memoryPath)
    call mem_deallocate(this%bditems, 'BDITEMS', this%memoryPath)
    call mem_deallocate(this%cbcauxitems, 'CBCAUXITEMS', this%memoryPath)
    call mem_deallocate(this%unitconv, 'UNITCONV', this%memoryPath)
    call mem_deallocate(this%lengthconv, 'LENGTHCONV', this%memoryPath)
    call mem_deallocate(this%timeconv, 'TIMECONV', this%memoryPath)
    call mem_deallocate(this%dmaxchg, 'DMAXCHG', this%memoryPath)
    call mem_deallocate(this%deps, 'DEPS', this%memoryPath)
    call mem_deallocate(this%nconn, 'NCONN', this%memoryPath)
    call mem_deallocate(this%icheck, 'ICHECK', this%memoryPath)
    call mem_deallocate(this%iconvchk, 'ICONVCHK', this%memoryPath)
    call mem_deallocate(this%idense, 'IDENSE', this%memoryPath)
    call mem_deallocate(this%ianynone, 'IANYNONE', this%memoryPath)
    call mem_deallocate(this%ncrossptstot, 'NCROSSPTSTOT', this%memoryPath)
    nullify (this%gwfiss)
    !

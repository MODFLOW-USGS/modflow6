...
contains
  ...
  subroutine npf_da(this)
    ...
    call mem_deallocate(this%ik22, 'IK22', this%memoryPath)
    call mem_deallocate(this%ik33, 'IK33', this%memoryPath)
    call mem_deallocate(this%iperched, 'IPERCHED', this%memoryPath)
    call mem_deallocate(this%ivarcv, 'IVARCV', this%memoryPath)
    call mem_deallocate(this%idewatcv, 'IDEWATCV', this%memoryPath)
    call mem_deallocate(this%ithickstrt, 'ITHICKSTRT', this%memoryPath)
    call mem_deallocate(this%isavspdis, 'ISAVSPDIS', this%memoryPath)
    call mem_deallocate(this%isavsat, 'ISAVSAT', this%memoryPath)
    call mem_deallocate(this%icalcspdis, 'ICALCSPDIS', this%memoryPath)
    call mem_deallocate(this%irewet, 'IREWET', this%memoryPath)
    call mem_deallocate(this%wetfct, 'WETFCT', this%memoryPath)
    call mem_deallocate(this%iwetit, 'IWETIT', this%memoryPath)
    call mem_deallocate(this%ihdwet, 'IHDWET', this%memoryPath)
    call mem_deallocate(this%ibotnode, 'IBOTNODE', this%memoryPath)
    call mem_deallocate(this%iwetdry, 'IWETDRY', this%memoryPath)
    call mem_deallocate(this%iangle1, 'IANGLE1', this%memoryPath)
    call mem_deallocate(this%iangle2, 'IANGLE2', this%memoryPath)
    call mem_deallocate(this%iangle3, 'IANGLE3', this%memoryPath)
    call mem_deallocate(this%nedges, 'NEDGES', this%memoryPath)
    call mem_deallocate(this%lastedge, 'LASTEDGE', this%memoryPath)
    call mem_deallocate(this%ik22overk, 'IK22OVERK', this%memoryPath)
    call mem_deallocate(this%ik33overk, 'IK33OVERK', this%memoryPath)
    call mem_deallocate(this%intvk, 'INTVK', this%memoryPath)
    call mem_deallocate(this%invsc, 'INVSC', this%memoryPath)
    call mem_deallocate(this%kchangeper, 'KCHANGEPER', this%memoryPath)
    call mem_deallocate(this%kchangestp, 'KCHANGESTP', this%memoryPath)
    !
    ! -- Deallocate arrays
    ...
    call mem_deallocate(this%k33, 'K33', this%memoryPath)
    call mem_deallocate(this%k11input, 'K11INPUT', this%memoryPath)
    call mem_deallocate(this%k22input, 'K22INPUT', this%memoryPath)
    call mem_deallocate(this%k33input, 'K33INPUT', this%memoryPath)
    call mem_deallocate(this%sat, 'SAT', this%memoryPath)
    call mem_deallocate(this%condsat, 'CONDSAT', this%memoryPath)
    call mem_deallocate(this%wetdry, 'WETDRY', this%memoryPath)
    call mem_deallocate(this%angle1, 'ANGLE1', this%memoryPath)
    call mem_deallocate(this%angle2, 'ANGLE2', this%memoryPath)
    call mem_deallocate(this%angle3, 'ANGLE3', this%memoryPath)
    call mem_deallocate(this%nodedge, 'NODEDGE', this%memoryPath)
    call mem_deallocate(this%ihcedge, 'IHCEDGE', this%memoryPath)
    call mem_deallocate(this%propsedge, 'PROPSEDGE', this%memoryPath)
    call mem_deallocate(this%spdis, 'SPDIS', this%memoryPath)
    call mem_deallocate(this%nodekchange, 'NODEKCHANGE', this%memoryPath)
    !
    ! -- deallocate parent

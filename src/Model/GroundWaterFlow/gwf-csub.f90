...
contains
  ...
  subroutine csub_da(this)
    ...
    if (this%inunit > 0) then
      call mem_deallocate(this%unodelist, 'UNODELIST', trim(this%memoryPath))
      call mem_deallocate(this%nodelist, 'NODELIST', trim(this%memoryPath))
      call mem_deallocate(this%idelay, 'IDELAY', trim(this%memoryPath))
      call mem_deallocate(this%ielastic, 'IELASTIC', trim(this%memoryPath))
      call mem_deallocate(this%iconvert, 'ICONVERT', trim(this%memoryPath))
      !
      ! -- grid-based storage data
      call mem_deallocate(this%buff, 'BUFF', trim(this%memoryPath))
      call mem_deallocate(this%buffusr, 'BUFFUSR', trim(this%memoryPath))
      call mem_deallocate(this%sgm, 'SGM', trim(this%memoryPath))
      call mem_deallocate(this%sgs, 'SGS', trim(this%memoryPath))
      call mem_deallocate(this%cg_ske_cr, 'CG_SKE_CR',  trim(this%memoryPath))
      call mem_deallocate(this%cg_gs, 'CG_GS', trim(this%memoryPath))
      call mem_deallocate(this%cg_es, 'CG_ES',  trim(this%memoryPath))
      call mem_deallocate(this%cg_es0, 'CG_ES0',  trim(this%memoryPath))
      call mem_deallocate(this%cg_pcs, 'CG_PCS',  trim(this%memoryPath))
      call mem_deallocate(this%cg_comp, 'CG_COMP',  trim(this%memoryPath))
      call mem_deallocate(this%cg_tcomp, 'CG_TCOMP',  trim(this%memoryPath))
      call mem_deallocate(this%cg_stor, 'CG_STOR',  trim(this%memoryPath))
      call mem_deallocate(this%cg_ske, 'CG_SKE',  trim(this%memoryPath))
      call mem_deallocate(this%cg_sk, 'CG_SK',  trim(this%memoryPath))
      if (this%iupdatematprop == 0) then
        ...
        call mem_deallocate(this%cg_thick, 'CG_THICK', trim(this%memoryPath))
        call mem_deallocate(this%cg_thick0, 'CG_THICK0', trim(this%memoryPath))
        call mem_deallocate(this%cg_theta, 'CG_THETA', trim(this%memoryPath))
        call mem_deallocate(this%cg_theta0, 'CG_THETA0', trim(this%memoryPath))
      end if
      call mem_deallocate(this%cg_thickini, 'CG_THICKINI', trim(this%memoryPath))
      call mem_deallocate(this%cg_thetaini, 'CG_THETAINI', trim(this%memoryPath))
      !
      ! -- cell storage
      call mem_deallocate(this%cell_wcstor, 'CELL_WCSTOR', trim(this%memoryPath))
      call mem_deallocate(this%cell_thick, 'CELL_THICK', trim(this%memoryPath))
      !
      ! -- interbed storage
      ...
      call mem_deallocate(this%ci, 'CI', trim(this%memoryPath))
      call mem_deallocate(this%rci, 'RCI', trim(this%memoryPath))
      call mem_deallocate(this%pcs, 'PCS', trim(this%memoryPath))
      call mem_deallocate(this%rnb, 'RNB', trim(this%memoryPath))
      call mem_deallocate(this%kv, 'KV', trim(this%memoryPath))
      call mem_deallocate(this%h0, 'H0', trim(this%memoryPath))
      call mem_deallocate(this%comp, 'COMP', trim(this%memoryPath))
      call mem_deallocate(this%tcomp, 'TCOMP', trim(this%memoryPath))
      call mem_deallocate(this%tcompi, 'TCOMPI', trim(this%memoryPath))
      call mem_deallocate(this%tcompe, 'TCOMPE', trim(this%memoryPath))
      call mem_deallocate(this%storagee, 'STORAGEE', trim(this%memoryPath))
      call mem_deallocate(this%storagei, 'STORAGEI', trim(this%memoryPath))
      call mem_deallocate(this%ske, 'SKE', trim(this%memoryPath))
      call mem_deallocate(this%sk, 'SK', trim(this%memoryPath))
      if (this%iupdatematprop == 0) then
        nullify (this%thick)
        nullify (this%thick0)
        nullify (this%theta)
        ...
        call mem_deallocate(this%thick, 'THICK', trim(this%memoryPath))
        call mem_deallocate(this%thick0, 'THICK0', trim(this%memoryPath))
        call mem_deallocate(this%theta, 'THETA', trim(this%memoryPath))
        call mem_deallocate(this%theta0, 'THETA0', trim(this%memoryPath))
      end if
      call mem_deallocate(this%thickini, 'THICKINI', trim(this%memoryPath))
      call mem_deallocate(this%thetaini, 'THETAINI', trim(this%memoryPath))
      !
      ! -- delay bed storage
      if (this%ndelaybeds > 0) then
        if (this%iupdatematprop == 0) then
          ...
          call mem_deallocate(this%dbdz, 'DBDZ', trim(this%memoryPath))
          call mem_deallocate(this%dbdz0, 'DBDZ0', trim(this%memoryPath))
        ...
        call mem_deallocate(this%dbrelz, 'DBRELZ', trim(this%memoryPath))
        call mem_deallocate(this%dbh, 'DBH', trim(this%memoryPath))
        call mem_deallocate(this%dbh0, 'DBH0', trim(this%memoryPath))
        call mem_deallocate(this%dbgeo, 'DBGEO', trim(this%memoryPath))
        call mem_deallocate(this%dbes, 'DBES', trim(this%memoryPath))
        call mem_deallocate(this%dbes0, 'DBES0', trim(this%memoryPath))
        call mem_deallocate(this%dbpcs, 'DBPCS', trim(this%memoryPath))
        call mem_deallocate(this%dbflowtop, 'DBFLOWTOP', trim(this%memoryPath))
        call mem_deallocate(this%dbflowbot, 'DBFLOWBOT', trim(this%memoryPath))
        call mem_deallocate(this%dbdzini, 'DBDZINI', trim(this%memoryPath))
        call mem_deallocate(this%dbthetaini, 'DBTHETAINI', trim(this%memoryPath))
        call mem_deallocate(this%dbcomp, 'DBCOMP', trim(this%memoryPath))
        call mem_deallocate(this%dbtcomp, 'DBTCOMP', trim(this%memoryPath))
        !
        ! -- delay interbed solution arrays
        call mem_deallocate(this%dbal, 'DBAL', trim(this%memoryPath))
        call mem_deallocate(this%dbad, 'DBAD', trim(this%memoryPath))
        call mem_deallocate(this%dbau, 'DBAU', trim(this%memoryPath))
        call mem_deallocate(this%dbrhs, 'DBRHS', trim(this%memoryPath))
        call mem_deallocate(this%dbdh, 'DBDH', trim(this%memoryPath))
        call mem_deallocate(this%dbaw, 'DBAW', trim(this%memoryPath))
      end if
      !
      ! -- period data
      call mem_deallocate(this%nodelistsig0, 'NODELISTSIG0', this%memoryPath)
    ...
    !
    ! -- deallocate scalars
    call mem_deallocate(this%istounit, 'ISTOUNIT', this%memoryPath)
    call mem_deallocate(this%inobspkg, 'INOBSPKG', this%memoryPath)
    call mem_deallocate(this%ninterbeds, 'NINTERBEDS', this%memoryPath)
    call mem_deallocate(this%maxsig0, 'MAXSIG0', this%memoryPath)
    call mem_deallocate(this%nbound, 'NBOUND', this%memoryPath)
    call mem_deallocate(this%iscloc, 'ISCLOC', this%memoryPath)
    call mem_deallocate(this%iauxmultcol, 'IAUXMULTCOL', this%memoryPath)
    call mem_deallocate(this%ndelaycells, 'NDELAYCELLS', this%memoryPath)
    call mem_deallocate(this%ndelaybeds, 'NDELAYBEDS', this%memoryPath)
    call mem_deallocate(this%initialized, 'INITIALIZED', this%memoryPath)
    call mem_deallocate(this%ieslag, 'IESLAG', this%memoryPath)
    call mem_deallocate(this%ipch, 'IPCH', this%memoryPath)
    call mem_deallocate(this%lhead_based, 'LHEAD_BASED', this%memoryPath)
    call mem_deallocate(this%iupdatestress, 'IUPDATESTRESS', this%memoryPath)
    call mem_deallocate(this%ispecified_pcs, 'ISPECIFIED_PCS', this%memoryPath)
    call mem_deallocate(this%ispecified_dbh, 'ISPECIFIED_DBH', this%memoryPath)
    call mem_deallocate(this%inamedbound, 'INAMEDBOUND', this%memoryPath)
    call mem_deallocate(this%iconvchk, 'ICONVCHK', this%memoryPath)
    call mem_deallocate(this%naux, 'NAUX', this%memoryPath)
    call mem_deallocate(this%istoragec, 'ISTORAGEC', this%memoryPath)
    call mem_deallocate(this%istrainib, 'ISTRAINIB', this%memoryPath)
    call mem_deallocate(this%istrainsk, 'ISTRAINSK', this%memoryPath)
    call mem_deallocate(this%ioutcomp, 'IOUTCOMP', this%memoryPath)
    call mem_deallocate(this%ioutcompi, 'IOUTCOMPI', this%memoryPath)
    call mem_deallocate(this%ioutcompe, 'IOUTCOMPE', this%memoryPath)
    ...
    call mem_deallocate(this%gammaw, 'GAMMAW', this%memoryPath)
    call mem_deallocate(this%beta, 'BETA', this%memoryPath)
    call mem_deallocate(this%brg, 'BRG', this%memoryPath)
    call mem_deallocate(this%satomega, 'SATOMEGA', this%memoryPath)
    call mem_deallocate(this%icellf, 'ICELLF', this%memoryPath)
    call mem_deallocate(this%gwfiss0, 'GWFISS0', this%memoryPath)
    !

...
!<
  ...
  subroutine maw_da(this)
    ...
    call mem_deallocate(this%ngwfnodes, 'NGWFNODES', this%memoryPath)
    call mem_deallocate(this%ieqn, 'IEQN', this%memoryPath)
    call mem_deallocate(this%ishutoff, 'ISHUTOFF', this%memoryPath)
    call mem_deallocate(this%ifwdischarge, 'IFWDISCHARGE', this%memoryPath)
    call mem_deallocate(this%strt, 'STRT', this%memoryPath)
    call mem_deallocate(this%radius, 'RADIUS', this%memoryPath)
    call mem_deallocate(this%area, 'AREA', this%memoryPath)
    ...
    call mem_deallocate(this%fwcondsim, 'FWCONDSIM', this%memoryPath)
    call mem_deallocate(this%xsto, 'XSTO', this%memoryPath)
    call mem_deallocate(this%xoldsto, 'XOLDSTO', this%memoryPath)
    call mem_deallocate(this%shutoffmin, 'SHUTOFFMIN', this%memoryPath)
    call mem_deallocate(this%shutoffmax, 'SHUTOFFMAX', this%memoryPath)
    call mem_deallocate(this%shutofflevel, 'SHUTOFFLEVEL', this%memoryPath)
    call mem_deallocate(this%shutoffweight, 'SHUTOFFWEIGHT', this%memoryPath)
    call mem_deallocate(this%shutoffdq, 'SHUTOFFDQ', this%memoryPath)
    call mem_deallocate(this%shutoffqold, 'SHUTOFFQOLD', this%memoryPath)
    !
    ! -- timeseries aware variables
    call mem_deallocate(this%mauxvar, 'MAUXVAR', this%memoryPath)
    call mem_deallocate(this%rate, 'RATE', this%memoryPath)
    call mem_deallocate(this%well_head, 'WELL_HEAD', this%memoryPath)
    !
    ! -- connection data
    call mem_deallocate(this%iaconn, 'IACONN', this%memoryPath)
    call mem_deallocate(this%gwfnodes, 'GWFNODES', this%memoryPath)
    call mem_deallocate(this%sradius, 'SRADIUS', this%memoryPath)
    ...
    call mem_deallocate(this%topscrn, 'TOPSCRN', this%memoryPath)
    call mem_deallocate(this%botscrn, 'BOTSCRN', this%memoryPath)
    !
    ! -- imap vector
    ...
    call mem_deallocate(this%qfw, 'QFW', this%memoryPath)
    call mem_deallocate(this%qout, 'QOUT', this%memoryPath)
    call mem_deallocate(this%qsto, 'QSTO', this%memoryPath)
    call mem_deallocate(this%qconst, 'QCONST', this%memoryPath)
    ...
    call mem_deallocate(this%idxlocnode, 'IDXLOCNODE', this%memoryPath)
    call mem_deallocate(this%idxdglo, 'IDXDGLO', this%memoryPath)
    call mem_deallocate(this%idxoffdglo, 'IDXOFFDGLO', this%memoryPath)
    call mem_deallocate(this%idxsymdglo, 'IDXSYMDGLO', this%memoryPath)
    call mem_deallocate(this%idxsymoffdglo, 'IDXSYMOFFDGLO', this%memoryPath)
    ...
    !
    ! -- scalars
    call mem_deallocate(this%correct_flow, 'CORRECT_FLOW', this%memoryPath)
    call mem_deallocate(this%iprhed, 'IPRHED', this%memoryPath)
    call mem_deallocate(this%iheadout, 'IHEADOUT', this%memoryPath)
    call mem_deallocate(this%ibudgetout, 'IBUDGETOUT', this%memoryPath)
    call mem_deallocate(this%ibudcsv, 'IBUDCSV', this%memoryPath)
    call mem_deallocate(this%iflowingwells, 'IFLOWINGWELLS', this%memoryPath)
    call mem_deallocate(this%imawiss, 'IMAWISS', this%memoryPath)
    call mem_deallocate(this%imawissopt, 'IMAWISSOPT', this%memoryPath)
    call mem_deallocate(this%nmawwells, 'NMAWWELLS', this%memoryPath)
    ...
    call mem_deallocate(this%theta, 'THETA', this%memoryPath)
    call mem_deallocate(this%kappa, 'KAPPA', this%memoryPath)

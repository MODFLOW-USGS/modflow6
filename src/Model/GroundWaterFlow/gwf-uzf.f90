...
30  format(i10)
  ...
  subroutine uzf_da(this)
    ...
    !
    ! -- deallocate scalars
    call mem_deallocate(this%iprwcont, 'IPRWCONT', this%memoryPath)
    call mem_deallocate(this%iwcontout, 'IWCONTOUT', this%memoryPath)
    ...
    call mem_deallocate(this%ntrail_pvar, 'NTRAIL_PVAR', this%memoryPath)
    call mem_deallocate(this%nsets, 'NSETS', this%memoryPath)
    call mem_deallocate(this%nodes, 'NODES', this%memoryPath)
    call mem_deallocate(this%istocb, 'ISTOCB', this%memoryPath)
    call mem_deallocate(this%nwav_pvar, 'NWAV_PVAR', this%memoryPath)
    call mem_deallocate(this%totfluxtot, 'TOTFLUXTOT', this%memoryPath)
    call mem_deallocate(this%bditems, 'BDITEMS', this%memoryPath)
    call mem_deallocate(this%nbdtxt, 'NBDTXT', this%memoryPath)
    call mem_deallocate(this%issflag, 'ISSFLAG', this%memoryPath)
    call mem_deallocate(this%issflagold, 'ISSFLAGOLD', this%memoryPath)
    call mem_deallocate(this%readflag, 'READFLAG', this%memoryPath)
    call mem_deallocate(this%iseepflag, 'ISEEPFLAG', this%memoryPath)
    call mem_deallocate(this%imaxcellcnt, 'IMAXCELLCNT', this%memoryPath)
    call mem_deallocate(this%ietflag, 'IETFLAG', this%memoryPath)
    call mem_deallocate(this%igwetflag, 'IGWETFLAG', this%memoryPath)
    call mem_deallocate(this%iuzf2uzf, 'IUZF2UZF', this%memoryPath)
    ...
    call mem_deallocate(this%appliedinf, 'APPLIEDINF', this%memoryPath)
    call mem_deallocate(this%rejinf, 'REJINF', this%memoryPath)
    call mem_deallocate(this%rejinf0, 'REJINF0', this%memoryPath)
    call mem_deallocate(this%rejinftomvr, 'REJINFTOMVR', this%memoryPath)
    call mem_deallocate(this%infiltration, 'INFILTRATION', this%memoryPath)
    call mem_deallocate(this%gwet_pvar, 'GWET_PVAR', this%memoryPath)
    call mem_deallocate(this%uzet, 'UZET', this%memoryPath)
    call mem_deallocate(this%gwd, 'GWD', this%memoryPath)
    call mem_deallocate(this%gwd0, 'GWD0', this%memoryPath)
    call mem_deallocate(this%gwdtomvr, 'GWDTOMVR', this%memoryPath)
    call mem_deallocate(this%rch, 'RCH', this%memoryPath)
    call mem_deallocate(this%rch0, 'RCH0', this%memoryPath)
    call mem_deallocate(this%qsto, 'QSTO', this%memoryPath)
    call mem_deallocate(this%deriv, 'DERIV', this%memoryPath)
    call mem_deallocate(this%qauxcbc, 'QAUXCBC', this%memoryPath)
    call mem_deallocate(this%wcnew, 'WCNEW', this%memoryPath)
    call mem_deallocate(this%wcold, 'WCOLD', this%memoryPath)
    !
    ...
    call mem_deallocate(this%sinf_pvar, 'SINF_PVAR', this%memoryPath)
    call mem_deallocate(this%pet_pvar, 'PET_PVAR', this%memoryPath)
    call mem_deallocate(this%extdp, 'EXDP_PVAR', this%memoryPath)
    call mem_deallocate(this%extwc_pvar, 'EXTWC_PVAR', this%memoryPath)
    call mem_deallocate(this%ha_pvar, 'HA_PVAR', this%memoryPath)
    call mem_deallocate(this%hroot_pvar, 'HROOT_PVAR', this%memoryPath)
    call mem_deallocate(this%rootact_pvar, 'ROOTACT_PVAR', this%memoryPath)
    call mem_deallocate(this%uauxvar, 'UAUXVAR', this%memoryPath)
    !
    ! -- Parent object

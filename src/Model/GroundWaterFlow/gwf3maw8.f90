          ...
          select case (obsrv%ObsTypeId)
            ...
            case ('CONDUCTANCE')
              ...
              if (this%iboundpak(n) /= 0) then
                ...
                !igwfnode = this%get_gwfnode(n, nn)

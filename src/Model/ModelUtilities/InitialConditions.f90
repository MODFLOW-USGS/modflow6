!> Base initial conditions package
module InitialConditionsModule
  ...
  type, extends(NumericalPackageType) :: IcType
...
contains
  ...
  subroutine ic_cr(ic, name_model, input_mempath, inunit, iout, dis)
    ...
    character(len=*), parameter :: fmtic = &
      "(1x, /1x, 'IC -- Initial Conditions Package', &
...
end module InitialConditionsModule

...
subroutine solution_create(filename, id)
  ...
  subroutine allocate_scalars(this)
    ...
    ! -- allocate scalars
    call mem_allocate(this%id, 'ID', this%memoryPath, this%attrs_scalars)  ! 1  The Attrs shoehorn in action!
    call mem_allocate(this%iu, 'IU', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ttform, 'TTFORM', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ttsoln, 'TTSOLN', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%isymmetric, 'ISYMMETRIC', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%neq, 'NEQ', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%nja, 'NJA', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%dvclose, 'DVCLOSE', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%bigchold, 'BIGCHOLD', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%bigch, 'BIGCH', this%memoryPath, this%attrs_scalars)  ! 10
    call mem_allocate(this%relaxold, 'RELAXOLD', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%res_prev, 'RES_PREV', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%res_new, 'RES_NEW', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%icnvg, 'ICNVG', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%itertot_timestep, 'ITERTOT_TIMESTEP', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%iouttot_timestep, 'IOUTTOT_TIMESTEP', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%itertot_sim, 'INNERTOT_SIM', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%mxiter, 'MXITER', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%linmeth, 'LINMETH', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%nonmeth, 'NONMETH', this%memoryPath, this%attrs_scalars)  ! 20
    call mem_allocate(this%iprims, 'IPRIMS', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%theta, 'THETA', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%akappa, 'AKAPPA', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%gamma, 'GAMMA', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%amomentum, 'AMOMENTUM', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%breduc, 'BREDUC', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%btol, 'BTOL', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%res_lim, 'RES_LIM', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%numtrack, 'NUMTRACK', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ibflag, 'IBFLAG', this%memoryPath, this%attrs_scalars)  ! 30
    call mem_allocate(this%icsvouterout, 'ICSVOUTEROUT', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%icsvinnerout, 'ICSVINNEROUT', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%nitermax, 'NITERMAX', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%convnmod, 'CONVNMOD', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%iallowptc, 'IALLOWPTC', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%iptcopt, 'IPTCOPT', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%iptcout, 'IPTCOUT', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%l2norm0, 'L2NORM0', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ptcdel, 'PTCDEL', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ptcdel0, 'PTCDEL0', this%memoryPath, this%attrs_scalars)  ! 40
    call mem_allocate(this%ptcexp, 'PTCEXP', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ptcthresh, 'PTCTHRESH', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%ptcrat, 'PTCRAT', this%memoryPath, this%attrs_scalars)
    call mem_allocate(this%atsfrac, 'ATSFRAC', this%memoryPath, this%attrs_scalars)  ! 44

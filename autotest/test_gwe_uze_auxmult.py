...
UZE will stop with an error msg.  Multiple UZF objects in a cell is not
supported in UZE.  Two variations of the same test problem are scripted; the
...
simulation containing the GWE model should error out.
"""

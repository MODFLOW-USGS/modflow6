...
def run_flow_model():
    ...
    for ipak, i in enumerate(rows):
        blist = []
        blist.append(((0, i, ncol - 1), 50., 1000., 100.))
    ...
    for ipak, i in enumerate(rows):
        blist = []
        blist.append(((0, i, ncol - 1), 50., 1000., 0., 100.))
...
def run_transport_model():
    ...
    sourcerecarray = [('WEL-1', 'AUX', 'CONCENTRATION')] \
                     + [('GHB-{}'.format(i + 1), 'AUX', 'CONCENTRATION') for i in [0, 1, 2, 3]] \

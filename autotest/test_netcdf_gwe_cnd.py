...
def build_models(idx, test):
    ...
    flopy.mf6.ModflowTdis(
        sim, nper=nper, perioddata=tdis_rc, time_units=time_units, start_date_time="2041-01-01T00:00:00-05:00",
    )
    ...
    flopy.mf6.ModflowGweic(
        gwe, export_array_netcdf=True, strt=strt_temp, filename="{}.ic".format(gwename)
    )

...
def eval_transport(sim):
    ...
    cres = np.array([
       6.19536860e+01, 6.10977621e+01, 5.94331187e+01, 5.70585587e+01,
       5.41016012e+01, 5.06360797e+01, 4.67594881e+01, 4.26131186e+01,
       3.83506623e+01, 3.41052863e+01, 2.99834184e+01, 2.60685066e+01,
       2.24239296e+01, 1.90924262e+01, 1.60976346e+01, 1.34466507e+01,
       1.11331123e+01, 9.14042952e+00, 7.44487655e+00, 6.01834933e+00,
       4.83067716e+00, 3.85144623e+00, 3.05134631e+00, 2.40308745e+00,
       1.88195336e+00, 1.46606535e+00, 1.13642906e+00, 8.76828593e-01,
       6.73622452e-01, 5.15484358e-01, 3.93121351e-01, 2.98992183e-01,
       2.27041270e-01, 1.72457391e-01, 1.31461916e-01, 1.01128195e-01,
       7.92317943e-02, 6.41300864e-02, 5.46692350e-02, 5.01165648e-02])

    csim = csim[:, 2, 12]
    # rtol is set larger here because convergence is looser
    assert np.allclose(cres, csim, rtol=1.e-4), 'simulated concentrations do not match with known solution.'

...
home = os.path.expanduser('d:\checkouts')
...
def get_mf6_models():
    ...
    exclude = ('test006_03models',
               'test018_NAC',
               'test051_uzf1d_a',
               'test006_2models-XT3D',      # fix from here!!!
               'test019_VilhelmsenLGR_nr',
               'test049_gwfexgrewet')
    
    exclude_mvr = ('test006_2models_mvr_dev',
                   'test011_mflgr_ex3_sfr',
                   'test029_lgrsfr_parentchild')
               

    exclude_gnc = ('test006_2models_gnc',
                   'test006_2models_mvr_dev',
                   'test006_2models_unconf_nr_gnc',
                   'test011_mflgr_ex3',
                   'test011_mflgr_ex3_sfr',
                   'test029_lgr_parentchild',
                   'test029_lgrsfr_parentchild',
                   'test048_lgr3d_conf',
                   'test048_lgr3d_unconf',
                   'test048_lgr3d_unconfB',
                   'test048_lgr3d_unconfC',
                   'test048_lgr3d_unconfD')
    ...
    exclude = list(exclude + exclude_travis + exclude_mvr + exclude_gnc)

...
def eval_results(sim):
    ...
    mwtemp_file = os.path.join(sim.simpath, fname)
    ...
    # Retrieve budget
    fname = os.path.join(sim.simpath, gwename + '.lst')
    srchStr = "MWE-1 BUDGET FOR ENTIRE MODEL AT END OF TIME STEP    1, " \
              "STRESS PERIOD   1"
    ...
    msg1 = "Conductive heat exchanges calculated explicitly and by MF6 " \
           "do not match"
    msg2 = "Individually summing well bore 'heat flows' is not matching " \

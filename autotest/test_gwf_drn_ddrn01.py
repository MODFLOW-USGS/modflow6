...
xlen = 1000.
delc, delr = 1., xlen / ncol
top, botm = 10., 0.

# temporal discretization
nper = 1
nyears = 10.
period_data = [(10. * nyears, 100, 1.1)]

kh, sy, ss = 10., .1, 1e-5
h0, h1 = 9., 1.
obs_recarray = {'head_obs.csv':[('h1_1_1', 'HEAD', (0, 0, 0)),
...
def build_model(idxsim, ws, name):
    ...
    obs_package = flopy.mf6.ModflowUtlobs(gwf, digits=20, print_input=True,

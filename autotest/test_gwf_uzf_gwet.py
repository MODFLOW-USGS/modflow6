...
def get_model(idx, dir):
    ...
    zero = 0.
    uzf_spd = {
        0: [[ 0, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
        ...
        1:[[ 0, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 1, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 2, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 3, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 4, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
        ...
        2:[[ 0, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 1, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 2, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 3, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 4, 0.01, pet, extdp, 7.0E-02, zero, zero, zero],
        ...
        3:[[ 0, zero, pet, extdp, 7.0E-02, zero, zero, zero],
        ...
        4:[[ 0, zero, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 1, zero, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 2, zero, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 3, zero, pet, extdp, 7.0E-02, zero, zero, zero],
           [ 4, zero, pet, extdp, 7.0E-02, zero, zero, zero],
        ...
        for i in range(sim.uzf_3lay.dis.nrow.get_data()):
            for j in range(sim.uzf_3lay.dis.ncol.get_data()):
                if (0, i, j) in cell_iuz_dict:
                    iuz = cell_iuz_dict[(0, i, j)]  # For this test, pET only specified in the top layer
                ...
                if pet > 0:
                    ...
                    assert abs(aet) <= pet, "Actual ET exceeds pET at row " + str(i + 1) + " column " + str(j + 1)

...
def eval_results(sim):
    ...
    lktemp_file = os.path.join(sim.simpath, fname)
    ...
    msg2 = "Thermal conduction is occurring in the wrong direction based " \
           "on the thermal gradient between the lake and groundwater system"
    msg3 = "There should be a cooling trend in the lake based on heat loss " \
           "to the groundwater system"
    msg4 = "There should be a warming trend in the groundwater adjacent " \
           "to the lake"
    msg5 = "Budget item 'GWF' should reflect heat entering the lake " \
           "(via gw/sw exchange)"
    msg6 = "Budget item 'GWF' should reflect heat exiting the lake " \
           "(via gw/sw exchange)"

...
def get_model(idx, dir):
    ...
    wellrecarray = [[0, 0.1, wellbottom, 100., 'THIEM', 1],
                    [1, 0.1, wellbottom, 100., 'THIEM', 1]]
    wellconnectionsrecarray = [[0, 0, (0, 0, 1), 100., wellbottom, 1., 0.1],
                               [1, 0, (0, 0, 1), 100., wellbottom, 1., 0.1]]
    wellperiodrecarray = {0: [[0, 'rate', -20.], [0, 'status', 'inactive'], [0, 'rate_scaling', 1., 15.],
                              [1, 'rate', -30.], [1, 'status', 'inactive'], [1, 'rate_scaling', 5., 15.]],
                          1: [[0, 'rate', -110.], [0, 'status', 'active'],
...
def eval_maw(sim):
    ...
    for key in bud_lst:
        d[key] = 0.
    fpth = os.path.join(sim.simpath,
                        '{}.maw.cbc'.format(os.path.basename(sim.name)))

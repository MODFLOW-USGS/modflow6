    ...
    for k in range(nlay):
        for i in range(nrow):
            for j in range(ncol):
                ...
                if j == 0:
                    icellnum = itricellnum[i, j]
                    wellist.append([(k, icellnum), qwell, 1.])
...
def eval_transport(sim):
    ...
    cres1 = [9.75305991e-01, 9.52167956e-01, 9.13498872e-01, 8.56445999e-01,
       7.81408232e-01, 6.92105105e-01, 5.94528731e-01, 4.95411393e-01,
       4.00833986e-01, 3.15336441e-01, 2.41600024e-01, 1.80579344e-01,
       1.31891325e-01, 9.42846759e-02, 6.60695310e-02, 4.54473575e-02,
       3.07275409e-02, 2.04445131e-02, 1.34007670e-02, 8.66203225e-03,
       5.52640971e-03, 3.48306266e-03, 2.17022758e-03, 1.33775921e-03,
       8.16313473e-04, 4.93397804e-04, 2.95551417e-04, 1.75541689e-04,
       1.03427957e-04, 6.04769621e-05, 3.51080337e-05, 2.02416209e-05,
       1.15945184e-05, 6.60031880e-06, 3.73515492e-06, 2.10185144e-06,
       1.17640119e-06, 4.52726328e-07]
    cres1 = np.array(cres1)

    cres2 = [9.91666434e-01, 9.86953589e-01, 9.80778200e-01, 9.56402197e-01,
       8.95573236e-01, 7.94392952e-01, 6.64374858e-01, 5.24436564e-01,
       3.92222699e-01, 2.79262303e-01, 1.90214211e-01, 1.24507826e-01,
       7.86404693e-02, 4.81012219e-02, 2.85822809e-02, 1.65449352e-02,
       9.35203645e-03, 5.17291859e-03, 2.80515816e-03, 1.49375662e-03,
       7.82221788e-04, 4.03333373e-04, 2.05011749e-04, 1.02829466e-04,
       5.09423767e-05, 2.49472500e-05, 1.20857205e-05, 5.79592865e-06,
       2.75322526e-06, 1.29620095e-06, 6.05117190e-07, 2.80245975e-07,
       1.28825482e-07, 5.87741819e-08, 2.66893805e-08, 1.19138575e-08,
       5.57865554e-09, 1.01007992e-09]
    cres2 = np.array(cres2)

    cres3 = [ 9.75305991e-01,  9.61567354e-01,  9.44318192e-01,  8.99780324e-01,
        8.53444404e-01,  7.57522910e-01,  6.71042660e-01,  5.31510001e-01,
        4.26626889e-01,  2.94209725e-01,  2.11149438e-01,  1.26488690e-01,
        8.13031158e-02,  4.27834908e-02,  2.48703736e-02,  1.16850355e-02,
        6.22057950e-03,  2.65348164e-03,  1.30994628e-03,  5.15075141e-04,
        2.38494633e-04,  8.75806378e-05,  3.84075388e-05,  1.33165430e-05,
        5.57286464e-06,  1.84101848e-06,  7.40051254e-07,  2.34149161e-07,
        9.11456220e-08,  2.77537863e-08,  1.06492160e-08,  3.18846190e-09,
        1.21166402e-09,  3.76715755e-10,  1.31716572e-10,  3.23063284e-11,
        9.77588885e-12, -1.56168535e-12]

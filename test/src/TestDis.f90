...
contains
  ...
  subroutine testDisGetCellxy
    ...
    ! create a disv with 2x6 (delr=100.0,delc=100.0) cells
    ...
    call assert_equal_realdp(y, 50.0_DP, "y coordinate cell 2")
  
    call dis%get_cellxy(12, x, y)
    call assert_equal_realdp(x, 550.0_DP, "x coordinate cell 12")
    call assert_equal_realdp(y, 150.0_DP, "y coordinate cell 12")
